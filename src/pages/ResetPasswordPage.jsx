...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(error);
      const msg = error.response?.data?.message || 'Erro ao redefinir senha. O link pode ter expirado.';
      setErrorMessage(msg);
      setStatus('error');
    }
  };
      ...
      <div className="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden relative z-10 p-8 md:p-10 animate-fade-in-up">
        ...
        {status === 'success' ? (
          <div className="bg-green-50 border border-green-100 rounded-xl p-6 text-center animate-fade-in">
            ...
            <h3 className="text-lg font-bold text-green-800 mb-1">Senha Alterada!</h3>
